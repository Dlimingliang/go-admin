...
type Menu struct {
	...
	Component  string        `json:"component" gorm:"type:varchar(100);not null;comment:前端文件路径"`             //前端文件路径
...
type Meta struct {
	Name      string `json:"title" gorm:"type:varchar(20);not null;uniqueIndex:name_delete_unique;comment:菜单名称"` //菜单名称
