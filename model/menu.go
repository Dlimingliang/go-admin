...
type Menu struct {
	...
	Parameters    []interface{} `json:"parameters" gorm:"-"`
	MenuBtn       []interface{} `json:"menuBtn" gorm:"-"`
	SysAuthoritys []interface{} `json:"authoritys" gorm:"-"`
}
...
type Meta struct {
	...
	KeepAlive bool   `json:"keepAlive" gorm:"-"`                                         // 是否缓存
	CloseTab  bool   `json:"closeTab" gorm:"-"`                                          // 自动关闭tab
}
